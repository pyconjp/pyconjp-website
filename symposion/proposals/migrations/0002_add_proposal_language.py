...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'ProposalBase.language'
        db.delete_column(u'proposals_proposalbase', 'language')
    ...
    models = {
        ...
        u'proposals.proposalbase': {
            ...
            'language': ('django.db.models.fields.CharField', [], {'default': "'English'", 'max_length': '2'}),
