...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Benefit.content_type'
        db.add_column(u'sponsorship_benefit', 'content_type',
                      self.gf('django.db.models.fields.CharField')(default='simple', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Benefit.content_type'
        db.delete_column(u'sponsorship_benefit', 'content_type')
    ...
    models = {
        ...
        u'sponsorship.benefit': {
            ...
            'content_type': ('django.db.models.fields.CharField', [], {'default': "'simple'", 'max_length': '20'}),
