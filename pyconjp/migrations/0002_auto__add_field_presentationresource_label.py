...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PresentationResource.label'
        db.add_column(u'pyconjp_presentationresource', 'label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PresentationResource.label'
        db.delete_column(u'pyconjp_presentationresource', 'label')
    ...
    models = {
        ...
        u'pyconjp.presentationresource': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '16'}),
